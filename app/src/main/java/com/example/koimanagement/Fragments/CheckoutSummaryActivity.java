    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSuccess.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Handle success action (e.g., show a success message or navigate to order details)
                Intent intent = new Intent(CheckoutSummaryActivity.this, BillingActivity.class); // Navigate to order summary or confirmation
